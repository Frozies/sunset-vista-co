...
const glossaryTerms: GlossaryItem[] = [{
    ...
    definition: "The process of improving your website so it appears higher in Google search results when people search for your services.",
    example: "If you're a plumber in Cape Coral, SEO helps you show up when someone searches 'plumber near me'.",
}, {
    term: "GEO (Generative Engine Optimization)",
    definition: "The process of optimizing your content so it appears in AI-powered search engines and chatbots like ChatGPT or Google Gemini. GEO helps your business stay visible as search shifts from traditional Google results to AI-generated answers.",
    ...
    definition: "Online advertising where you pay each time someone clicks on your ad. Google Ads and Facebook Ads are examples.",
    ...
    definition: "Creating valuable content (blogs, videos, guides) to attract and educate potential customers.",
    ...
    definition: "Marketing activities designed to attract potential customers and get their contact information.",
    example: "Offering a free guide in exchange for someone's email address.",
}, {
    term: "Google My Business",
    definition: "Your free business profile on Google that appears in local searches and Google Maps.",
...
export default function GlossaryPage() {
    return (<div>
            ...
            <section
                className="py-16 bg-gradient-to-br from-primary/5 via-accent/5 to-background border-y border-border/50">
                <div className="container mx-auto px-4">
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-10">
                            ...
                            <p className="text-muted-foreground">Click any term below to jump directly to its
                                definition</p>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                            {glossaryTerms.map((item) => (<Link
                                    key={item.slug}
                                    href={`#${item.slug}`}
                  ...
                  <span className="relative z-10 text-foreground group-hover:text-primary transition-colors">
                    {item.term}
                                    ...
                                    <div
                                        className="absolute inset-0 bg-gradient-to-r from-primary/0 via-primary/5 to-accent/5 opacity-0 group-hover:opacity-100 transition-opacity"/>
                                </Link>))}
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20" aria-labelledby="terms-heading">
                <div className="container mx-auto px-4">
                    ...
                    <dl className="max-w-4xl mx-auto space-y-6">
                        {glossaryTerms.map((item) => (<div key={item.slug} id={item.slug} className="scroll-mt-24">
                                <article
                                    className="group"
                                    itemScope
...
// Expects `glossaryTerms` to be in scope at the page level (the array you already have)
export function GlossaryJsonLd({
    ...
    const definedTermSetLd = {
        ...
        "@type": "DefinedTermSet",
        "@id": `${pageUrl}#digital-marketing-glossary`,
        ...
        hasDefinedTerm: terms.map((t) => ({
            ...
            url: `${pageUrl}#${t.slug}`,
            inDefinedTermSet: `${pageUrl}#digital-marketing-glossary`,
        })),
    }
    ...
    const breadcrumbLd = {
        "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{
            ...
            "@type": "ListItem", position: 2, name: "Marketing Glossary", item: pageUrl,
        },],
    }
    ...
    const webPageLd = {
        ...
        "@id": `${pageUrl}#webpage`,
        url: pageUrl,
        name: "Digital Marketing Glossary — Plain-English Definitions for Local Businesses | Sunset Vista",
        description: "Understand SEO, GEO, PPC, schema markup, CTR, and more with simple definitions tailored to local businesses in Southwest Florida.",
        isPartOf: {
            "@type": "WebSite", name: "Sunset Vista", url: site,
        },
        breadcrumb: {
    ...
    const organizationLd = {
        ...
        url: site,
        logo: `${site}/logo.png`,
        sameAs: ["https://www.facebook.com/sunsetvista.co", "https://www.linkedin.com/company/sunsetvista", "https://x.com/sunsetvista_co",],
    }

    return (<>
            <Script
                id="ld-defined-term-set"

...
export const metadata: Metadata = {
    ...
    description:
        "Read the terms and conditions for using Sunset Vista Co. services, including our legal terms, user rights, and service policies.",
    robots: "index, follow",
}
            ...
            <div className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">
                        <strong>Last updated:</strong> October 04, 2025
                    </p>
                </div>
                ...
                <div className="bg-card border rounded-lg p-6 mb-8">
                    ...
                    <nav className="space-y-2">
                        <Link href="#agreement" className="block text-primary hover:underline">
                            Agreement to Our Legal Terms
                        </Link>
                        <Link href="#services" className="block text-primary hover:underline">
                            1. Our Services
                        </Link>
                        <Link href="#ip" className="block text-primary hover:underline">
                            2. Intellectual Property Rights
                        </Link>
                        <Link href="#userreps" className="block text-primary hover:underline">
                            3. User Representations
                        </Link>
                        <Link href="#purchases" className="block text-primary hover:underline">
                            4. Purchases and Payment
                        </Link>
                        <Link href="#subscriptions" className="block text-primary hover:underline">
                            5. Subscriptions
                        </Link>
                        <Link href="#prohibited" className="block text-primary hover:underline">
                            6. Prohibited Activities
                        </Link>
                        <Link href="#ugc" className="block text-primary hover:underline">
                            7. User Generated Contributions
                        </Link>
                        <Link href="#license" className="block text-primary hover:underline">
                            8. Contribution License
                        </Link>
                        <Link href="#services-mgmt" className="block text-primary hover:underline">
                            9. Services Management
                        </Link>
                        <Link href="#ppyes" className="block text-primary hover:underline">
                            10. Privacy Policy
                        </Link>
                        <Link href="#terms" className="block text-primary hover:underline">
                            11. Term and Termination
                        </Link>
                        <Link href="#modifications" className="block text-primary hover:underline">
                            12. Modifications and Interruptions
                        </Link>
                        <Link href="#law" className="block text-primary hover:underline">
                            13. Governing Law
                        </Link>
                        <Link href="#disputes" className="block text-primary hover:underline">
                            14. Dispute Resolution
                        </Link>
                        <Link href="#corrections" className="block text-primary hover:underline">
                            15. Corrections
                        </Link>
                        <Link href="#disclaimer" className="block text-primary hover:underline">
                            16. Disclaimer
                        </Link>
                        <Link href="#liability" className="block text-primary hover:underline">
                            17. Limitations of Liability
                        </Link>
                        <Link href="#indemnification" className="block text-primary hover:underline">
                            18. Indemnification
                        </Link>
                        <Link href="#userdata" className="block text-primary hover:underline">
                            19. User Data
                        </Link>
                        <Link href="#electronic" className="block text-primary hover:underline">
                            20. Electronic Communications
                        </Link>
                        <Link href="#california" className="block text-primary hover:underline">
                            21. California Users and Residents
                        </Link>
                        <Link href="#misc" className="block text-primary hover:underline">
                            22. Miscellaneous
                        </Link>
                ...
                <div className="prose prose-slate max-w-none">
                    <section id="agreement" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">Agreement to Our Legal Terms</h2>
                        <p className="mb-4">
                            We are <strong>Sunset Vista Company, LLC</strong>, doing business as <strong>Sunset Vista Co.</strong>{" "}
                            (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;).
                        </p>
                        <p className="mb-4">
                            We operate the website{" "}
                            <a
                                href="https://www.sunsetvista.co"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-primary hover:underline"
                            >
                                https://www.sunsetvista.co
                            </a>{" "}
                        ...
                        <p className="mb-4">
                            ...
                            or by mail to 821 Sw 48th Ter, Cape Coral, FL 33914, United States.
                        </p>
                        <p className="mb-4">
                            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf
                            of an entity (&quot;you&quot;), and Sunset Vista Company, LLC, concerning your access to and use of the
                    ...
                    <section id="services" className="mb-8 scroll-mt-20">
                    ...
                    <section id="ip" className="mb-8 scroll-mt-20">
                        ...
                        <h3 className="text-xl font-semibold mb-3 mt-6">Your use of our Services</h3>
                        <p className="mb-4">
                        ...
                        <h3 className="text-xl font-semibold mb-3 mt-6">Your submissions</h3>
                        <p className="mb-4">
                    ...
                    <section id="userreps" className="mb-8 scroll-mt-20">
                    ...
                    <section id="purchases" className="mb-8 scroll-mt-20">
                    ...
                    <section id="subscriptions" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">5. Subscriptions</h2>
                        <h3 className="text-xl font-semibold mb-3 mt-6">Billing and Renewal</h3>
                        <p className="mb-4">
                        ...
                        <p className="mb-4">
                            ...
                            below. Your cancellation will take effect at the end of the current paid term. If you have any questions
                        ...
                        <h3 className="text-xl font-semibold mb-3 mt-6">Fee Changes</h3>
                        <p>
                    ...
                    <section id="prohibited" className="mb-8 scroll-mt-20">
                    ...
                    <section id="ugc" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">7. User Generated Contributions</h2>
                        <p className="mb-4">
                    ...
                    <section id="license" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">8. Contribution License</h2>
                        <p className="mb-4">
                    ...
                    <section id="services-mgmt" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">9. Services Management</h2>
                    ...
                    <section id="modifications" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">12. Modifications and Interruptions</h2>
                        <p className="mb-4">
                    ...
                    <section id="law" className="mb-8 scroll-mt-20">
                        ...
                        <p>
                            These Legal Terms shall be governed by and defined following the laws of the United States. Sunset Vista
                            Company, LLC and yourself irrevocably consent that the courts of the United States shall have exclusive
                    ...
                    <section id="disputes" className="mb-8 scroll-mt-20">
                        ...
                        <h3 className="text-xl font-semibold mb-3 mt-6">Informal Negotiations</h3>
                        <p className="mb-4">
                            ...
                            thirty (30) days before initiating arbitration. Such informal negotiations commence upon written notice
                        ...
                        <p className="mb-4">
                            ...
                            146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part
                            of this clause. The number of arbitrators shall be three (3). The seat, or legal place, or arbitration
                            shall be Cape Coral, Florida. The language of the proceedings shall be English. The governing law of these
                            Legal Terms shall be substantive law of the United States.
                        </p>
                        ...
                        <h3 className="text-xl font-semibold mb-3 mt-6">Exceptions to Informal Negotiations and Arbitration</h3>
                        <p>
                    ...
                    <section id="corrections" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">15. Corrections</h2>
                        <p>
                    ...
                    <section id="disclaimer" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">16. Disclaimer</h2>
                    ...
                    <section id="liability" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">17. Limitations of Liability</h2>
                    ...
                    <section id="indemnification" className="mb-8 scroll-mt-20">
                    ...
                    <section id="userdata" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">19. User Data</h2>
                        <p>
                    ...
                    <section id="electronic" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">20. Electronic Communications, Transactions, and Signatures</h2>
                        <p>
                    ...
                    <section id="california" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">21. California Users and Residents</h2>
                        <p>
                    ...
                    <section id="misc" className="mb-8 scroll-mt-20">
                        <h2 className="text-2xl font-bold mb-4">22. Miscellaneous</h2>
                        <p>
                    ...
                    <section id="contact" className="mb-8 scroll-mt-20">
                        ...
                        <div className="bg-card border rounded-lg p-6">
                            <p className="font-semibold mb-2">Sunset Vista Company, LLC</p>
                            <p>821 Sw 48th Ter</p>
